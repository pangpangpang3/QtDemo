...
QT_MOC_LITERAL(6, 45, 11), // "messageSlot"
QT_MOC_LITERAL(7, 57, 10), // "actionSlot"
QT_MOC_LITERAL(8, 68, 15), // "textChangedSlot"
QT_MOC_LITERAL(9, 84, 7), // "newText"
QT_MOC_LITERAL(10, 92, 15), // "sendClickedSlot"
QT_MOC_LITERAL(11, 108, 14), // "changeNickname"
QT_MOC_LITERAL(12, 123, 7), // "aboutQt"
QT_MOC_LITERAL(13, 131, 7) // "exiting"

    },
    "ChatMainWindow\0message\0\0nickname\0text\0"
    "action\0messageSlot\0actionSlot\0"
    "textChangedSlot\0newText\0sendClickedSlot\0"
    "changeNickname\0aboutQt\0exiting"
};
...
void ChatMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->messageSlot((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 3: _t->actionSlot((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 4: _t->textChangedSlot((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->sendClickedSlot(); break;
        case 6: _t->changeNickname(); break;
        case 7: _t->aboutQt(); break;
        case 8: _t->exiting(); break;
        default: ;
        }
        ...
        {
            typedef void (ChatMainWindow::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChatMainWindow::message)) {
                *result = 0;
            }
        }
        {
            typedef void (ChatMainWindow::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChatMainWindow::action)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ChatMainWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ChatMainWindow.data,
...
void *ChatMainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ChatMainWindow"))
        return static_cast< Ui::ChatMainWindow*>(const_cast< ChatMainWindow*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NicknameDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject NicknameDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_NicknameDialog.data,
      qt_meta_data_NicknameDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_NicknameDialog.stringdata))
        return static_cast<void*>(const_cast< NicknameDialog*>(this));
    if (!strcmp(_clname, "Ui::NicknameDialog"))
        return static_cast< Ui::NicknameDialog*>(const_cast< NicknameDialog*>(this));
