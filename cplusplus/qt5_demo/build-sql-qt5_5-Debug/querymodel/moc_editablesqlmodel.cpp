...
#include "../../sql/querymodel/editablesqlmodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EditableSqlModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EditableSqlModel_t qt_meta_stringdata_EditableSqlModel = {
    {
QT_MOC_LITERAL(0, 0, 16) // "EditableSqlModel"
...
const QMetaObject EditableSqlModel::staticMetaObject = {
    { &QSqlQueryModel::staticMetaObject, qt_meta_stringdata_EditableSqlModel.data,
      qt_meta_data_EditableSqlModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EditableSqlModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EditableSqlModel.stringdata0))
