...
#include "../../itemviews/spreadsheet/printview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PrintView_t, stringdata) + ofs \
...
const QMetaObject PrintView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_PrintView.data,
      qt_meta_data_PrintView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PrintView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PrintView.stringdata))
