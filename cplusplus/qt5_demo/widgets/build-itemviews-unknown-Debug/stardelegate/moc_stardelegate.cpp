...
#include "../../itemviews/stardelegate/stardelegate.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StarDelegate_t, stringdata) + ofs \
...
void *StarDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StarDelegate.stringdata))
