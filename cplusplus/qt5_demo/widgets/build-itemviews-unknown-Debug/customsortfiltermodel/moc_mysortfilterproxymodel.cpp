...
#include "../../itemviews/customsortfiltermodel/mysortfilterproxymodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MySortFilterProxyModel_t, stringdata) + ofs \
...
void *MySortFilterProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MySortFilterProxyModel.stringdata))
