...
#include "../../itemviews/frozencolumn/freezetablewidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FreezeTableWidget_t, stringdata) + ofs \
...
void *FreezeTableWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FreezeTableWidget.stringdata))
