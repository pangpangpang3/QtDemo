...
#include "../../itemviews/spinboxdelegate/delegate.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SpinBoxDelegate_t, stringdata) + ofs \
...
void *SpinBoxDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SpinBoxDelegate.stringdata))
