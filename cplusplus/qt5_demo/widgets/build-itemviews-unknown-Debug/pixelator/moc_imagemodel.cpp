...
#include "../../itemviews/pixelator/imagemodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImageModel_t, stringdata) + ofs \
...
const QMetaObject ImageModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_ImageModel.data,
...
void *ImageModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageModel.stringdata))
