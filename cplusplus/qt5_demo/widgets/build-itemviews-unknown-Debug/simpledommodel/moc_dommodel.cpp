...
#include "../../itemviews/simpledommodel/dommodel.h"
...
struct qt_meta_stringdata_DomModel_t {
    QByteArrayData data[1];
    char stringdata[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DomModel_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DomModel_t qt_meta_stringdata_DomModel = {
    {
QT_MOC_LITERAL(0, 0, 8) // "DomModel"
...
const QMetaObject DomModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_DomModel.data,
      qt_meta_data_DomModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DomModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DomModel.stringdata))
