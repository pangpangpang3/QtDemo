...
#include "../../itemviews/addressbook/adddialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddDialog_t, stringdata) + ofs \
...
void *AddDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddDialog.stringdata))
