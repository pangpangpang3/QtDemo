...
#include "../../itemviews/addressbook/addresswidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddressWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 56, 8), // "addEntry"
QT_MOC_LITERAL(6, 65, 4), // "name"
QT_MOC_LITERAL(7, 70, 7), // "address"
QT_MOC_LITERAL(8, 78, 9), // "editEntry"
QT_MOC_LITERAL(9, 88, 11) // "removeEntry"

    },
    "AddressWidget\0selectionChanged\0\0"
    "QItemSelection\0selected\0addEntry\0name\0"
    "address\0editEntry\0removeEntry"
};
...
const QMetaObject AddressWidget::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_AddressWidget.data,
      qt_meta_data_AddressWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AddressWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddressWidget.stringdata))
        return static_cast<void*>(const_cast< AddressWidget*>(this));
