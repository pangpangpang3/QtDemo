...
#include "../../itemviews/addressbook/newaddresstab.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NewAddressTab_t, stringdata) + ofs \
...
void NewAddressTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NewAddressTab::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NewAddressTab::sendDetails)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject NewAddressTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NewAddressTab.data,
      qt_meta_data_NewAddressTab,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NewAddressTab::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NewAddressTab.stringdata))
        return static_cast<void*>(const_cast< NewAddressTab*>(this));
