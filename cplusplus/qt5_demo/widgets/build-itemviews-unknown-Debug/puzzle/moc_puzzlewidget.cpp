...
#include "../../itemviews/puzzle/puzzlewidget.h"
...
QT_MOC_LITERAL(1, 13, 15), // "puzzleCompleted"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "PuzzleWidget\0puzzleCompleted\0"
};
...
void PuzzleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->puzzleCompleted(); break;
        default: ;
        }
        ...
        {
            typedef void (PuzzleWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PuzzleWidget::puzzleCompleted)) {
                *result = 0;
            }
        }
    }
