...
#include "../../itemviews/storageview/storagemodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StorageModel_t, stringdata) + ofs \
...
const QMetaObject StorageModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_StorageModel.data,
      qt_meta_data_StorageModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StorageModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StorageModel.stringdata))
