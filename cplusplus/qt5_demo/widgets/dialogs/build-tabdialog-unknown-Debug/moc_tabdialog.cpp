...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GeneralTab_t, stringdata) + ofs \
...
const QMetaObject GeneralTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GeneralTab.data,
      qt_meta_data_GeneralTab,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GeneralTab::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GeneralTab.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PermissionsTab_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject PermissionsTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PermissionsTab.data,
      qt_meta_data_PermissionsTab,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_PermissionsTab.stringdata))
        return static_cast<void*>(const_cast< PermissionsTab*>(this));
    return QWidget::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ApplicationsTab_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject ApplicationsTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ApplicationsTab.data,
      qt_meta_data_ApplicationsTab,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_ApplicationsTab.stringdata))
        return static_cast<void*>(const_cast< ApplicationsTab*>(this));
    return QWidget::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TabDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_TabDialog.stringdata))
