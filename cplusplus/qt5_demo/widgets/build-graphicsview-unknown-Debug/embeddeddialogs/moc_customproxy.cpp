...
#include "../../graphicsview/embeddeddialogs/customproxy.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CustomProxy_t, stringdata) + ofs \
...
void *CustomProxy::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomProxy.stringdata))
