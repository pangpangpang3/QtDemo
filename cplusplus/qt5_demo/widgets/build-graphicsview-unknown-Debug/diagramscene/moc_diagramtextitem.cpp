...
#include "../../graphicsview/diagramscene/diagramtextitem.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DiagramTextItem_t, stringdata) + ofs \
...
void *DiagramTextItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DiagramTextItem.stringdata))
